...
#define ms_debug(...)           MS2_LOGD(__VA_ARGS__)
#define ms_message(...)         MS2_LOGI(__VA_ARGS__)
#define ms_warning(...)         MS2_LOGW(__VA_ARGS__)
#define ms_error(...)           MS2_LOGE(__VA_ARGS__)
#define ms_fatal(...)           MS2_LOGF(__VA_ARGS__)
