...
#define MS_JSND_GET_WCB	MS_FILTER_EVENT(MS_FILE_PLAYER_ID, 1, int)
#define MS_JSND_GET_RCB	MS_FILTER_EVENT(MS_FILE_REC_ID, 1, int)

#if CONFIG_TUTK_ENABLE
#define MS_TUTK_AR_SET_UID	MS_FILTER_EVENT(MS_TUTK_AUDIO_RECV_ID, 1, void*)
#define MS_TUTK_AS_SET_UID	MS_FILTER_EVENT(MS_TUTK_AUDIO_SEND_ID, 1, void*)
#define MS_TUTK_AS_SET_PAYLOAD	MS_FILTER_EVENT(MS_TUTK_AUDIO_SEND_ID, 2, int)
#define MS_TUTK_VR_SET_UID	MS_FILTER_EVENT(MS_TUTK_VIDEO_RECV_ID, 1, void*)
#endif
